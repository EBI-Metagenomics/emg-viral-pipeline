...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Format hmmer domain hits table.")
    parser.add_argument("-i", dest="input_table", help="hmmer domain hits table")
    parser.add_argument(
        "-o", "--outname", dest="outfile_name", help="Output table name"
    )
    parser.add_argument(
        "-t",
        "--hmmer-tool",
        dest="hmmer_tool",
        help="what hmm tool was used to generate input table",
