...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "To call -f file1.tsv -f file2.tsv...",
        required=True,
    )
    parser.add_argument(
        "-o", "--outfile", dest="outfile", help="OTU table count file", required=True
    )
    ...
    with open(args.outfile, "w", newline="") as tsv_out:
        tsv_writer = csv.writer(tsv_out, delimiter="\t", quoting=csv.QUOTE_MINIMAL)
