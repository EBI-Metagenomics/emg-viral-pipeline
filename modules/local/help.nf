...
def helpMSG() {
    ...
    ${c_yellow}Database download links (used when the corresponding path above is not provided):${c_reset}
    --virsorter_download_link     [default: $params.virsorter_download_link]
    --virsorter2_download_link    [default: $params.virsorter2_download_link]
    --virfinder_download_link     [default: $params.virfinder_download_link]
    --viphog_download_link        [default: $params.viphog_download_link]
    --rvdb_download_link          [default: $params.rvdb_download_link]
    --pvogs_download_link         [default: $params.pvogs_download_link]
    --vogdb_download_link         [default: $params.vogdb_download_link]
    --vpf_download_link           [default: $params.vpf_download_link]
    --ncbi_download_link          [default: $params.ncbi_download_link]
    --checkv_download_link        [default: $params.checkv_download_link]
    --imgvr_download_link         [default: $params.imgvr_download_link]
    --pprmeta_download_link       [default: $params.pprmeta_download_link]
    --meta_download_link          [default: $params.meta_download_link]
